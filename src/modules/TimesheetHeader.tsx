...
import {Download, FilterX, Grid3X3, Plus, TableRowsSplit, ChevronRight, ChevronLeft} from "lucide-react";
    ...
    return (
        <header className="flex justify-between items-center mb-5">
            ...
            <div className="flex gap-2">
                ...
                <Button className="flex gap-1" variant="outline" onClick={moveToPrevMonth}>
                    <ChevronLeft size="18"/>
                </Button>
                <DatePickerWithRange value={dateRange ?? undefined} onSelect={(date) => date && setDateRange(date)}/>
                <Button className="flex gap-1" variant="outline" onClick={moveToNextMonth}>
